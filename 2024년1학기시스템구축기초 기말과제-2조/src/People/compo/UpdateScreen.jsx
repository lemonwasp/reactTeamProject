  ...
  return (
    <>
      ...
      <div className="P-modal-wrap">
        <header>
          <h2>{props.title}</h2>
          <button id="P-x-btn" onClick={props.onClose}>
            X
          </button>
        </header>
        <div className="content">
          ...
          >
            <div>
              Img
              <div>
                <textarea name="img" defaultValue={props.user.img}></textarea>
              </div>
            </div>
            <div>
              Name
              <div>
                <textarea name="name" defaultValue={props.user.name}></textarea>
              </div>
            </div>
            <div>
              Skill
              <div>
                <textarea name="skill" defaultValue={props.user.skill}></textarea>
              </div>
            </div>
            <div>
              Experience
              <div>
                <textarea name="experience" defaultValue={props.user.experience}></textarea>
              </div>
            </div>
            <div>
              Contact
              <div>
                <textarea name="contact" defaultValue={props.user.contact}></textarea>
              </div>
            </div>
            <div>
              Hobbie
              <div>
                <textarea name="hobbie" defaultValue={props.user.hobbie}></textarea>
              </div>
            </div>
            <footer>
